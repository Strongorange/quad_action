...
public class GameManager : MonoBehaviour
{
    ...
    IEnumerator InBattle()
    {
        ...
        {
            enemyCntD++;
            GameObject instantEnemy = Instantiate(
                enemies[3],
                enemyZones[0].position,
                enemyZones[0].rotation
            );
            EnemyController enemy = instantEnemy.GetComponent<EnemyController>();
            enemy.target = player.transform;
            enemy.manager = this;
            boss = instantEnemy.GetComponent<BossController>();
        }
        else
        {
    ...
    void LateUpdate()
    {
        ...
        if (boss != null)
        {
            ...
            bossHealthBar.localScale = new Vector3(
                (float)boss.currentHealth / boss.maxHealth,
                1,
                1
            );
        }
